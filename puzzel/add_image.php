...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("delete from img  WHERE img_id=%s",
...
mysql_select_db($database_h, $h);
$query_Recordset1 = sprintf("SELECT * FROM lesson WHERE lesson_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
$insertSQL = sprintf("INSERT INTO img (img,lesson_id) VALUES (%s,%s)",
...
mysql_select_db($database_h, $h);
$query_Recordset2 = sprintf("SELECT * FROM img WHERE lesson_id = %s", GetSQLValueString($colname_Recordset2, "int"));
